...
function buildPackage(
  ...
  const pkg: ProductionPackage = {
    ...
    claim_ledger: [],
    script_plan: {
      angle: "리서치와 분석 후 영상 각도를 정해야 합니다.",
      hook: "소스 분석 후 도입부를 작성해야 합니다.",
      outline: [
        "리서치 입력값을 저장했습니다.",
        "소스 영상을 분석합니다.",
        "사용할 주장을 확인합니다.",
      ...
      notes:
        input.sourceMode === "categoryTop"
          ? "카테고리 기반 후보 영상으로 시작한 제작 실행입니다. 리서치와 주장 확인 후 대본 초안을 채워 주세요."
          : input.sourceMode === "topicSearch"
            ? "주제 검색 기반 후보 영상으로 시작한 제작 실행입니다. 리서치와 주장 확인 후 대본 초안을 채워 주세요."
            : "수동 소스 영상으로 시작한 제작 실행입니다. 리서치와 주장 확인 후 대본 초안을 채워 주세요.",
    },
    storyboard: [],
    media_prompts: {
      style_bible: "",
    ...
    qa: {
      status: "needs_review",
      blockers: [
        "소스 영상 분석이 아직 끝나지 않았습니다.",
        "주장 목록이 아직 비어 있습니다.",
        "대본 초안이 아직 기본 틀 상태입니다.",
    "스토리보드와 에셋 생성 요청서가 아직 완성되지 않았습니다.",
